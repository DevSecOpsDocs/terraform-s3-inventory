...
This module will help you setup s3 inventory reports on a specified bucket, create bucket for the reports, glue table to query the reports with athena, and allow for multiple inventoried buckets. For more information about doing so, please read the blog on [Data Lake Scavenger Hunt: Using S3 Inventory Reports to Identify Lost Data](https://devsecopsdocs.com/blog/s3-inventory-reports-to-identify-lost-data/).
